            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="exampleFormControlInput3" class="form-control" placeholder="Enter Email Address" wire:model="email" />
                        @error('email')<span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput4">Gender</label>
                        <select class="form-control" id="exampleFormControlInput4" wire:model="gender">
